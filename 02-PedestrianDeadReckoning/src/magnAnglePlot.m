function [] = magnAnglePlot(name,sec,magnHeadingAngle)
%clf;
figure(4);
...
legend1=legend('$\bf{mHeading Angle}$','Interpreter','latex','FontSize',10.5);  
...
title({'$\bf{Heading-from-Magnetometers}$'}, 'interpreter','latex','FontSize', 18);
grid on;
cd ..\tempfiles\
saveas(gcf,name, 'svg');
cd ..\src\
