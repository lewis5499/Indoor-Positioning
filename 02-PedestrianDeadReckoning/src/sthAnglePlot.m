function [] = sthAnglePlot(name,sec,smtRoll,smtPitch)
%clf;
figure(3);
set(gcf,'Position',get(0,'ScreenSize'));

plot(sec,smtRoll,'Color',[0.28 0.57 0.54],LineWidth=2);hold on%[0.62 0.49 0.31]%[0.73 0.47 0.58]%[0.26 0.45 0.80]%[0.28 0.57 0.54]
plot(sec,smtPitch,'Color',[0.73 0.47 0.58],LineWidth=2);
...
title({'$\bf{Horizontal-Angles:smoothed}$'}, 'interpreter','latex','FontSize', 18);
grid on;
cd ..\tempfiles\
saveas(gcf,name, 'svg');
cd ..\src\
